...
4. **Thai Quality**: ภาษาไทยต้องสละสลวย ไม่ดูเหมือนการแปลจาก Google Translate และไม่มีคำผิด
5. **JSON Integrity**: ตรวจสอบว่า `design_reasoning` ให้ข้อมูลที่มีประโยชน์ต่อครู ไม่ใช่แค่เขียนส่งๆ
